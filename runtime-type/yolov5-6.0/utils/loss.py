...
class ComputeOutbasedDstillLoss:
    def __init__(self, nc, distill_ratio=0.5):
        ...
        # self.DboxLoss = nn.KLDivLoss()
        # self.DclsLoss = nn.KLDivLoss()
        # self.DobjLoss = nn.KLDivLoss()
    def __call__(self, p, t_p, soft_loss='kl'):
        self.distill_ratio *= 0.95
        ...
        return loss * bs, torch.cat((t_lbox, t_lobj, t_lcls)).detach()
